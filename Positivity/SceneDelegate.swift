...
//            Backend.shared.storeInfoArray()
//            Backend.shared.setName(name: "Giannis")
            
//            UserDefaults.standard.removeObject(forKey: "progress")
            
            if (!Backend.shared.getProgress()){
                Backend.shared.getRandomCharm()
            }
            
            if UserDefaults.standard.string(forKey: "name") != nil{
                self.redirect(view: AnyView(ContentView()))
            } else {
                self.redirect(view: AnyView(IntroView()))
//                self.redirect(view: AnyView(MainView()))
            }
